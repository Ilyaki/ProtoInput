...
bool MessageList::IsBlocked(unsigned message, const std::vector<unsigned int>& blockedMessages)
{
	...
	return find(blockedMessages.begin(), blockedMessages.end(), message) != blockedMessages.end();
}
